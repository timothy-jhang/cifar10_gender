...
initial_lr = cifar10.INITIAL_LEARNING_RATE
decay_factor = cifar10.LEARNING_RATE_DECAY_FACTOR
no_epochs_decay = cifar10.NUM_EPOCHS_PER_DECAY
no_examples_epoch = cifar10.NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN 
dropout = 0.5
